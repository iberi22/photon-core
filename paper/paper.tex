...
\author{
    ...
    \texttt{https://github.com/iberi22}\\
...
Wang et al. \cite{wang2024} demonstrated 5D storage using self-assembled birefringent nanostructures created by femtosecond laser pulses in fused silica. Microsoft's Project Silica \cite{silica2024} achieved 7 TB capacity on a 75$\times$75$\times$2 mm glass plate using similar technology.
...
where $\lambda_i \in \{532, 650, 450, 800\}$ nm are the discrete wavelength levels.
